...
//初始化心跳源信息
func initHeartbeatInfo(m *dmap.Map, rate time.Duration) {
...
//获取心跳原信息
func getHeartbeatInfo(m *dmap.Map) (*heartbeatInfo, bool) {
...
//更新心跳源信息
func updateHeartbeatInfo(m *dmap.Map, rate time.Duration) (isFirst bool) {
