...
func Test_IntArray_Basic(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		expect := []int{0, 1, 2, 3}
		expect2 := []int{}
		array := darray.NewIntArrayFrom(expect)
		array2 := darray.NewIntArrayFrom(expect2)
...
func TestIntArray_Sort(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		array2 := darray.NewIntArray(true)
		for i := 3; i >= 0; i-- {
			array.Append(i)
			array2.Append(i)
		}
...
func TestIntArray_PopLeftsAndPopRights(t *testing.T) {
	...
	dtest.C(t, func(t *dtest.T) {
		...
		array1 := darray.NewIntArrayFrom(value1)
		array2 := darray.NewIntArrayFrom(value2)
...
func TestIntArray_Range(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		value1 := []int{0, 1, 2, 3, 4, 5, 6}
		array1 := darray.NewIntArrayFrom(value1)
		array2 := darray.NewIntArrayFrom(value1, true)
...
func TestIntArray_Merge(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		s1 := []string{"a", "b", "c"}
		s2 := []string{"e", "f"}
		a1 := darray.NewIntArrayFrom(n1)
		a2 := darray.NewIntArrayFrom(n2)
		a3 := darray.NewArrayFrom(i1)
		a4 := darray.NewStrArrayFrom(s1)

		a5 := darray.NewSortedStrArrayFrom(s2)
		a6 := darray.NewSortedIntArrayFrom([]int{1, 2, 3})

		a7 := darray.NewSortedStrArrayFrom(s1)
		a8 := darray.NewSortedArrayFrom([]interface{}{4, 5}, func1)
...
func TestIntArray_Fill(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		a1 := []int{0}
		a2 := []int{0}
		array1 := darray.NewIntArrayFrom(a1)
		array2 := darray.NewIntArrayFrom(a2)
...
func TestIntArray_PopLeft(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		array := darray.NewIntArrayFrom(d.SliceInt{1, 2, 3})
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestIntArray_SubSlice(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		array1 := darray.NewIntArrayFrom(a1)
		array2 := darray.NewIntArrayFrom(a1, true)
...
func TestIntArray_PopRands(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		array := darray.NewIntArrayFrom(a1)
...
func TestNewIntArrayFromCopy(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		a1 := []int{1, 2, 3, 5, 3}
		array1 := darray.NewIntArrayFromCopy(a1)
...
func TestIntArray_LockFunc(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		s1 := []int{1, 2, 3, 4}
		a1 := darray.NewIntArrayFrom(s1, true)
...
func TestIntArray_Json(t *testing.T) {
	...
	dtest.C(t, func(t *dtest.T) {
		...
		a2 := darray.NewIntArray()
		err1 = json.UnmarshalUseNumber(b2, &a2)
		t.Assert(a2.Slice(), s1)

		var a3 darray.IntArray
...
func TestIntArray_Iterator(t *testing.T) {
	...
	array := darray.NewIntArrayFrom(slice)
	dtest.C(t, func(t *dtest.T) {
...
func TestIntArray_FilterEmpty(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		array := darray.NewIntArrayFrom(d.SliceInt{0, 1, 2, 3, 4, 0})
		t.Assert(array.FilterEmpty(), d.SliceInt{1, 2, 3, 4})
	})
	dtest.C(t, func(t *dtest.T) {
		array := darray.NewIntArrayFrom(d.SliceInt{1, 2, 3, 4})
		t.Assert(array.FilterEmpty(), d.SliceInt{1, 2, 3, 4})
	})
}
...
func TestIntArray_Walk(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		array := darray.NewIntArrayFrom(d.SliceInt{1, 2})
