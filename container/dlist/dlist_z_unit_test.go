...
func checkListLen(t *dtest.T, l *List, len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers(t *dtest.T, l *List, es []*Element) {
...
func checkList(t *dtest.T, l *List, es []interface{}) {
	if !checkListLen(t, l, len(es)) {
		return
	}
