...
var anyAnyMap = dmap.NewAnyAnyMap(true)
var intIntMap = dmap.NewIntIntMap(true)
var intAnyMap = dmap.NewIntAnyMap(true)
var intStrMap = dmap.NewIntStrMap(true)
var strIntMap = dmap.NewStrIntMap(true)
var strAnyMap = dmap.NewStrAnyMap(true)
var strStrMap = dmap.NewStrStrMap(true)
