...
func Test_IntIntMap_Basic(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		m2 := dmap.NewIntIntMapFrom(map[int]int{1: 1, 2: 2})
...
func Test_IntIntMap_Iterator(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		m := dmap.NewIntIntMapFrom(expect)
...
func Test_IntIntMap_Clone(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		//clone 方法是深克隆
		m := dmap.NewIntIntMapFrom(map[int]int{1: 1, 2: 2})
...
func Test_IntIntMap_Merge(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m1 := dmap.NewIntIntMap()
		m2 := dmap.NewIntIntMap()
		m1.Set(1, 1)
		m2.Set(2, 2)
		m1.Merge(m2)
...
func Test_IntIntMap_Pop(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m := dmap.NewIntIntMapFrom(d.MapIntInt{
			1: 11,
			2: 22,
		})
		t.Assert(m.Size(), 2)
