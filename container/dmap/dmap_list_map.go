...
type ListMap struct {
	mu   rwmutex.RWMutex
	data map[interface{}]*dlist.Element
	list *dlist.List
}

type dListMapNode struct {
	key   interface{}
	value interface{}
}
...
func NewListMap(safe ...bool) *ListMap {
	return &ListMap{
		...
		data: make(map[interface{}]*dlist.Element),
		list: dlist.New(),
	}
}
...
func (m *ListMap) IteratorAsc(f func(key interface{}, value interface{}) bool) {
	...
	defer m.mu.RUnlock()
	if m.list != nil {
		node := (*dListMapNode)(nil)
		m.list.IteratorAsc(func(e *dlist.Element) bool {
			node = e.Value.(*dListMapNode)
...
func (m *ListMap) IteratorDesc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		node := (*dListMapNode)(nil)
		m.list.IteratorDesc(func(e *dlist.Element) bool {
			node = e.Value.(*dListMapNode)
			return f(node.key, node.value)
		})
	}
...
func (m *ListMap) Clear() {
	m.mu.Lock()
	m.data = make(map[interface{}]*dlist.Element)
	m.list = dlist.New()
	m.mu.Unlock()
}
...
func (m *ListMap) Replace(data map[interface{}]interface{}) {
	...
	for key, value := range data {
		if e, ok := m.data[key]; !ok {
			m.data[key] = m.list.PushBack(&dListMapNode{key, value})
		} else {
			e.Value = &dListMapNode{key, value}
		}
	}
	m.mu.Unlock()
}
...
func (m *ListMap) MapStrAny() map[string]interface{} {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *dlist.Element) bool {
			node = e.Value.(*dListMapNode)
			data[dconv.String(node.key)] = node.value
			return true
		})
	}
	m.mu.RUnlock()
...
func (m *ListMap) Search(key interface{}) (value interface{}, found bool) {
	...
	if m.data != nil {
		if e, ok := m.data[key]; ok {
			value = e.Value.(*dListMapNode).value
			found = ok
		}
	}
	m.mu.RUnlock()
...
func (m *ListMap) doSetWithLockCheck(key interface{}, value interface{}) interface{} {
	...
	if e, ok := m.data[key]; ok {
		return e.Value.(*dListMapNode).value
	}
...
func (m *ListMap) Keys() []interface{} {
	...
	if m.list != nil {
		m.list.IteratorAsc(func(e *dlist.Element) bool {
			keys[index] = e.Value.(*dListMapNode).key
			index++
			return true
		})
	}
...
func (m *ListMap) Values() []interface{} {
	...
	if m.list != nil {
		m.list.IteratorAsc(func(e *dlist.Element) bool {
			values[index] = e.Value.(*dListMapNode).value
			index++
			return true
		})
	}
...
func (m *ListMap) Merge(other *ListMap) {
	...
	node := (*dListMapNode)(nil)
	other.list.IteratorAsc(func(e *dlist.Element) bool {
		node = e.Value.(*dListMapNode)
		if e, ok := m.data[node.key]; !ok {
			m.data[node.key] = m.list.PushBack(&dListMapNode{node.key, node.value})
		} else {
			e.Value = &dListMapNode{node.key, node.value}
		}
		return true
	})
}
...
func (m *ListMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(dconv.Map(m.Map()))
}
...
func (m *ListMap) UnmarshalValue(value interface{}) (err error) {
	...
	for k, v := range dconv.Map(value) {
		if e, ok := m.data[k]; !ok {
			m.data[k] = m.list.PushBack(&dListMapNode{k, v})
		} else {
			e.Value = &dListMapNode{k, v}
		}
	}
	return
}
