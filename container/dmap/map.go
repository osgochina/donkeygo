...
// AtomicMap  is a concurrent map with loads, stores, and deletes.
...
// NewAtomicMap  creates a concurrent map with amortized-constant-time loads, stores, and deletes.
