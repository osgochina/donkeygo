...
func Test_IntStrMap_Basic(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		m2 := dmap.NewIntStrMapFrom(map[int]string{1: "a", 2: "b"})
...
func Test_IntStrMap_Iterator(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		m := dmap.NewIntStrMapFrom(expect)
...
func Test_IntStrMap_Clone(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		//clone 方法是深克隆
		m := dmap.NewIntStrMapFrom(map[int]string{1: "a", 2: "b", 3: "c"})
...
func Test_IntStrMap_Merge(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m1 := dmap.NewIntStrMap()
		m2 := dmap.NewIntStrMap()
		m1.Set(1, "a")
		m2.Set(2, "b")
		m1.Merge(m2)
...
func Test_IntStrMap_Pop(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m := dmap.NewIntStrMapFrom(d.MapIntStr{
			1: "v1",
			2: "v2",
		})
		t.Assert(m.Size(), 2)
