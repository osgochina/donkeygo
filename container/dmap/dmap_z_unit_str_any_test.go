...
func Test_StrAnyMap_Basic(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		m2 := dmap.NewStrAnyMapFrom(map[string]interface{}{"a": 1, "b": "2"})
...
func Test_StrAnyMap_Iterator(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		...
		m := dmap.NewStrAnyMapFrom(expect)
...
func Test_StrAnyMap_Clone(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		//clone 方法是深克隆
		m := dmap.NewStrAnyMapFrom(map[string]interface{}{"a": 1, "b": "2"})
...
func Test_StrAnyMap_Merge(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m1 := dmap.NewStrAnyMap()
		m2 := dmap.NewStrAnyMap()
		m1.Set("a", 1)
		m2.Set("b", "2")
		m1.Merge(m2)
...
func Test_StrAnyMap_Pop(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m := dmap.NewStrAnyMapFrom(d.MapStrAny{
			"k1": "v1",
			"k2": "v2",
		})
		t.Assert(m.Size(), 2)
