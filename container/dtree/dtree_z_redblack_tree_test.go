...
func Test_RedBlackTree_Basic(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m := dtree.NewRedBlackTree(dutil.ComparatorString)
		m.Set("key1", "val1")
		...
		m2 := dtree.NewRedBlackTreeFrom(dutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_RedBlackTree_Iterator(t *testing.T) {
	...
	m := dtree.NewRedBlackTreeFrom(dutil.ComparatorString, expect)
...
func Test_RedBlackTree_IteratorFrom(t *testing.T) {
	...
	tree := dtree.NewRedBlackTreeFrom(dutil.ComparatorInt, m)
...
func Test_RedBlackTree_Clone(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		//clone 方法是深克隆
		m := dtree.NewRedBlackTreeFrom(dutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
		m_clone := m.Clone()
		m.Remove(1)
...
func Test_RedBlackTree_LRNode(t *testing.T) {
	...
	//unsafe
	dtest.C(t, func(t *dtest.T) {
		m := dtree.NewRedBlackTreeFrom(dutil.ComparatorString, expect, true)
		t.Assert(m.Left().Key, "key1")
		t.Assert(m.Right().Key, "key4")
	})
}
...
func Test_RedBlackTree_CeilingFloor(t *testing.T) {
	...
	//found and eq
	dtest.C(t, func(t *dtest.T) {
		m := dtree.NewRedBlackTreeFrom(dutil.ComparatorInt, expect)
		c, cf := m.Ceiling(8)
		t.Assert(cf, true)
...
func Test_RedBlackTree_Remove(t *testing.T) {
	m := dtree.NewRedBlackTree(dutil.ComparatorInt)
	for i := 1; i <= 100; i++ {
