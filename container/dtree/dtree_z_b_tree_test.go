...
func Test_BTree_Basic(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		m := dtree.NewBTree(3, dutil.ComparatorString)
		m.Set("key1", "val1")
		...
		m2 := dtree.NewBTreeFrom(3, dutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_BTree_Iterator(t *testing.T) {
	...
	m := dtree.NewBTreeFrom(3, dutil.ComparatorString, expect)
...
func Test_BTree_IteratorFrom(t *testing.T) {
	...
	tree := dtree.NewBTreeFrom(3, dutil.ComparatorInt, m)
...
func Test_BTree_Clone(t *testing.T) {
	dtest.C(t, func(t *dtest.T) {
		//clone 方法是深克隆
		m := dtree.NewBTreeFrom(3, dutil.ComparatorString, map[interface{}]interface{}{1: 1, "key1": "val1"})
		m_clone := m.Clone()
		m.Remove(1)
...
func Test_BTree_LRNode(t *testing.T) {
	...
	//unsafe
	dtest.C(t, func(t *dtest.T) {
		m := dtree.NewBTreeFrom(3, dutil.ComparatorString, expect, true)
		t.Assert(m.Left().Key, "key1")
		t.Assert(m.Right().Key, "key4")
	})
}
...
func Test_BTree_Remove(t *testing.T) {
	m := dtree.NewBTree(3, dutil.ComparatorInt)
	for i := 1; i <= 100; i++ {
