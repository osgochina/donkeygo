...
var intSet = dset.NewIntSet(true)
var anySet = dset.NewSet(true)
var strSet = dset.NewStrSet(true)
var intSetUnsafe = dset.NewIntSet()
var anySetUnsafe = dset.NewSet()
var strSetUnsafe = dset.NewStrSet()
